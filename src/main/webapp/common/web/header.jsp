				...
				<li class="nav-item navbar-dropdown dropdown-user dropdown">
                  <a class="nav-link dropdown-toggle hide-arrow show" href="javascript:void(0);" data-bs-toggle="dropdown" aria-expanded="true">
                    <div class="avatar avatar-online">
                      <img width="50px" height="50px" src="<c:url value="/template/admin/assets/img/avatars/1.png" />" alt="" class="w-px-40 h-auto rounded-circle">
                    </div>
                  </a>
...
<nav id="mainNavbar" class="navbar navbar-dark bg-dark navbar-expand-md">
    ...
    <div class="collapse navbar-collapse" id="navLinks">
        <ul class="navbar-nav m-auto">
            ...
            <li class="nav-item">
                <a href="#" class="nav-link">${cats.name}</a>
            </li>
            </c:forEach> 
        </ul>
    </div>
