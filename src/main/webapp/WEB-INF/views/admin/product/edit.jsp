	...
	<div class="content-wrapper">
		...
		<div class="container-xxl flex-grow-1 container-p-y">
			<h4 class="fw-bold py-3 mb-4">
				<span class="text-muted fw-light">Forms /</span> Edit Product
				<span style="color: red;">${message}</span>
			</h4>

			<div class="d-flex">
				<div style="width: 500px;">
					<form:form method="post" action="edit-product"
						modelAttribute="productDTO" class="form-group" enctype="multipart/form-data">
						...
						<div class="form-group">
							...
							<form:input type="text" id="name" path="price"
								class="form-control" />
						</div>

						<div class="form-group">
							<label for="name">sale price</label>
							<form:input type="text" id="name" path="sale_price"
								class="form-control" />
						</div>
						...
						<div class="form-group">
							...
							<form:select path="category_id">
								<form:option value="${productDTO.category_id }"> --SELECT--</form:option>
